    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center bg-bg">
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <Button asChild className="px-5 py-3 text-sm font-medium bg-button-bg hover:bg-button-bg/90 transition-colors duration-200 rounded-xl2" style={{ color: 'rgb(254,241,59)' }}>
