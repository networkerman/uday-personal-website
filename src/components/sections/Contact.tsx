            ...
            <div className="space-y-6">
              {contactInfo.map((item, index) => (
                <div key={index} className="flex items-start">
                  <div className="p-2 bg-electric-blue/10 rounded-full mr-4">
                    {item.icon}
                  </div>
                  <div>
                    ...
                    {item.link ? (
                      <a 
                        href={item.link} 
                        className="text-gray-800 hover:text-electric-blue transition-colors"
